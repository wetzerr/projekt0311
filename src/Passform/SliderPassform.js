    ...
    <>
      <div className={styles.wrapper}>
        ...
        <div id={styles.sliderlabels}>
          <span style={{ visibility: 'visible' }} id={styles.figurbetont}>FIGURBETONT</span>
          <span style={{visibility:  'visible' }} id={styles.etwasenger}>ETWAS ENGER</span>
          <span style={{ visibility: 'visible' }} id={styles.regulär}>REGULÄR</span>
          <span style={{ visibility: 'visible' }} id={styles.etwaslockerer}>ETWAS LOCKERER</span>
          <span style={{ visibility: 'visible' }} id={styles.locker}>LOCKER</span>
        </div>
     </>
